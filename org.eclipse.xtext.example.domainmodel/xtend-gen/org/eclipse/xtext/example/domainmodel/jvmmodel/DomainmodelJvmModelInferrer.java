...
public class DomainmodelJvmModelInferrer extends AbstractModelInferrer {
  ...
  public void inferJavaClass(final Entity entity, @Extension final IJvmDeclaredTypeAcceptor acceptor, final boolean prelinkingPhase) {
    String _name = entity.getName();
    String _plus = (_name + "GenOnce");
    QualifiedName _create = QualifiedName.create("de", "model", "in", "java", "test", _plus);
    JvmGenericType impl = this._jvmTypesBuilder.toClass(entity, _create);
    EList<Adapter> _eAdapters = impl.eAdapters();
    DomainmodelOutputConfigurationAdapter _domainmodelOutputConfigurationAdapter = new DomainmodelOutputConfigurationAdapter("JAVA_OUTPUT");
    _eAdapters.add(_domainmodelOutputConfigurationAdapter);
    ...
    acceptor.<JvmGenericType>accept(impl, _function);
  }
  ...
  protected void _infer(final Entity entity, @Extension final IJvmDeclaredTypeAcceptor acceptor, final boolean prelinkingPhase) {
    this.inferJavaClass(entity, acceptor, prelinkingPhase);
