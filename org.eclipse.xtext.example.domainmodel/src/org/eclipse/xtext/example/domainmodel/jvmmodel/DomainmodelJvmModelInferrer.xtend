...
class DomainmodelJvmModelInferrer extends AbstractModelInferrer {
	...
	def inferJavaClass(Entity entity, extension IJvmDeclaredTypeAcceptor acceptor, boolean prelinkingPhase) {
		var impl = entity.toClass(QualifiedName.create("de", "model", "in", "java", "test", entity.name + "GenOnce"))
		impl.eAdapters.add(new DomainmodelOutputConfigurationAdapter("JAVA_OUTPUT"))
	...
	def dispatch infer(Entity entity, extension IJvmDeclaredTypeAcceptor acceptor, boolean prelinkingPhase) {
		inferJavaClass(entity, acceptor, prelinkingPhase)
